...
const FilaUsuario = React.memo(({ numero, usuario, onDetalle, onEditar, onEliminar, esSelf }) => (
    <tr className="border-b border-white/[0.04] hover:bg-white/[0.025] transition-colors">
        <td className="pl-5 pr-2 py-4 text-gray-600 text-xs tabular-nums text-center w-10">{numero}</td>
        <td className="px-4 py-4">
            <div className="flex items-center gap-2">
                <p className="font-medium text-white leading-snug">{usuario.nombre} {usuario.apellido}</p>
                {esSelf && (
                    <span className="text-[10px] px-1.5 py-0.5 bg-purple-500/[0.12] text-purple-400 border border-purple-500/20 leading-none">
                        Tú
                    </span>
                )}
            </div>
        </td>
        <td className="px-4 py-4 text-gray-500 text-xs hidden sm:table-cell max-w-[200px] truncate">{usuario.email}</td>
        <td className="px-4 py-4 text-gray-500 text-xs hidden md:table-cell whitespace-nowrap">{usuario.telefono || '—'}</td>
        <td className="px-4 py-4"><BadgeRol rol={usuario.rol} /></td>
        <td className="px-4 py-4 text-gray-500 text-xs hidden lg:table-cell whitespace-nowrap">{formatFecha(usuario.created_at)}</td>
                ...
                <button
                    ...
                    className={`p-2 transition-colors ${
                        esSelf
                            ...
                            : 'text-gray-600 hover:text-red-400 hover:bg-red-400/[0.06]'
                    }`}
                >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-md bg-gray-900 border border-white/[0.09]" style={ANIM_SCALE}>
                        <div className="flex items-center justify-between px-6 py-5 border-b border-white/[0.07]">
                            ...
                            <button onClick={cerrarDetalle} className="p-1.5 text-gray-600 hover:text-white transition-colors">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-lg bg-gray-900 border border-white/[0.09] flex flex-col max-h-[90vh]" style={ANIM_SCALE}>
                        <div className="flex items-center justify-between px-6 py-5 border-b border-white/[0.07] shrink-0">
                            ...
                            <button onClick={cerrarEditar} className="p-1.5 text-gray-600 hover:text-white transition-colors">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                </svg>
                            </button>
                        ...
                        <form onSubmit={manejarGuardar} className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <svg className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-600 pointer-events-none"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                    </svg>
                                </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-lg bg-gray-900 border border-white/[0.09] flex flex-col max-h-[90vh]" style={ANIM_SCALE}>
                        ...
                        <div className="flex items-center justify-between px-6 py-5 border-b border-white/[0.07] shrink-0">
                            ...
                            <button onClick={cerrarCrear} className="p-1.5 text-gray-600 hover:text-white transition-colors">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                </svg>
                            </button>
                            ...
                            <div>
                                ...
                                <div className="flex border border-white/[0.08] overflow-hidden focus-within:border-purple-500/60 focus-within:ring-1 focus-within:ring-purple-500/30 transition-colors">
                                    ...
                                    <input
                                        ...
                                        required
                                        className="flex-1 px-3 py-2.5 bg-white/[0.05] text-sm text-white placeholder-gray-600 focus:outline-none"
                                    />
                                </div>
