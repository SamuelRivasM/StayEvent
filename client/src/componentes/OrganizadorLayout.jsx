// ─── OrganizadorLayout — Layout con sidebar para el organizador ────────────────
...
const NAV_ITEMS = [
    { to: '/organizador/dashboard', icon: IconDashboard, label: 'Dashboard' },
    { to: '/organizador/eventos',   icon: IconEventos,   label: 'Gestión Eventos' },
];
            ...
            <div className="flex pt-16" style={{ position: 'relative', zIndex: 1 }}>
                ...
                >
                    <div className="px-4 py-5 border-b border-white/[0.06]">
                        ...
                        <h2 className="text-sm font-bold text-white">Panel Organizador</h2>
