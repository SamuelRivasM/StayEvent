        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-gray-950/90 backdrop-blur-md border-b border-white/5">
            <div className="max-w-7xl mx-auto px-5 sm:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    {/* Logo */}
                    <Link to="/" className="font-display text-lg font-black tracking-tight text-white hover:text-purple-300 transition-colors">
                        Stay Event
                    </Link>
                        ...
                        {usuario ? (
                            <>
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 text-sm font-medium text-gray-400 border border-white/15 hover:border-white/30 hover:text-white transition-all"
                                >
                                    Cerrar sesión
                                </button>
                            </>
                            ...
                            <>
                                ...
                                <Link
                                    to="/login"
                                    className="px-5 py-2 text-sm font-semibold text-white bg-purple-600 hover:bg-purple-500 active:bg-purple-700 transition-colors"
                                >
                                    Iniciar sesión
                                </Link>
                            </>
                ...
                {/* Mobile menu */}
                {menuAbierto && (
                    <div className="sm:hidden border-t border-white/8 py-3 space-y-1">
                        {usuario ? (
                            <>
